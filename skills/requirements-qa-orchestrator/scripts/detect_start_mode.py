...
STAGE_PATTERNS = {
    ...
    "generate-cases": ("test case", "test cases", "qa coverage", "coverage matrix", "scenario"),
...
def detect_start_mode(user_text: str) -> dict:
    ...
    requested_output = detect_requested_output(lowered, stage)
...
def detect_stage(lowered: str) -> str:
    explicit_priority = (
        ...
        ("generate-cases", ("generate test cases", "create test cases", "turn these requirements into test cases", "qa coverage")),
...
def detect_requested_output(lowered: str, stage: str) -> str:
